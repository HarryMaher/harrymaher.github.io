/*  
  ...
  httplabs.easyblog.it 
  
  Licensed under the MIT license. 
  
  Demo 
  httplabs.easyblog.itmapsleaflet-search 
  
  Source 
  git@github.comstefanocudinileaflet-search.git 
   */
...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		zoom: 5,					//zoom after pan to location found, default: map.getZoom()
